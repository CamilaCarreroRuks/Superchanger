 ...
 */
public class NotificationNegative implements NotificationsInterface{

    @Override
    public void notifyUser(String message) {
        Image icon = new ImageIcon(getClass().getResource("/images/negative.png")).getImage();
        ...
        JOptionPane.showMessageDialog(null, message, "Notificación", JOptionPane.WARNING_MESSAGE, imageIcon);
    }
